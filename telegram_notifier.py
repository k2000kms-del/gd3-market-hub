...
def notify_morning_briefing(
    ...
    text = (
        ...
        f"{kr_sec}\n"
        f"━━━━━━━━━━━━━━━━━━\n"
        f"🎯 <b>3. 오늘 권장 자산 배분 & 계좌 시초가 액션</b>\n"
        f"├ 💵 <b>권장 포트폴리오 비중</b>: 주식 <b>{stock_ratio:.0f}%</b> / 현금 <b>{cash_ratio:.0f}%</b>\n"
        f"├ ⚡ <b>시장 볼린저 에너지</b>: <b>{bollinger_status}</b>\n"
        f"└ 💼 <b>대표님 보유 계좌 지침</b>:\n"
        f"{port_sec}"
        f"{gap_trap_line}\n"
        f"   💡 <i>당일 수급이 확인된 '실시간 퀀트 TOP3'는 09:30 이후 장중에 포착됩니다.</i>\n"
        f"━━━━━━━━━━━━━━━━━━\n"
